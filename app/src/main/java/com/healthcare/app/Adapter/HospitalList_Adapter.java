...
public class HospitalList_Adapter extends RecyclerView.Adapter<HospitalList_Adapter.ViewHolder> {
    ...
    public HospitalList_Adapter(Context context,  List<HospitalDatum> hospitalData){
    ...
    @Override
    public HospitalList_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_toprated,parent,false);
        return new HospitalList_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HospitalList_Adapter.ViewHolder holder, int position) {
