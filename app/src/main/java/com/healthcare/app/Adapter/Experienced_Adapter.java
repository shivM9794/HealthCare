...
public class Experienced_Adapter extends RecyclerView.Adapter<Experienced_Adapter.ViewHolder> {
    ...
    public Experienced_Adapter(Context context, List<Doctordatum> doctordata){
    ...
    @Override
    public Experienced_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_exp_doc,parent,false);
        return new Experienced_Adapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Experienced_Adapter.ViewHolder holder, int position) {
